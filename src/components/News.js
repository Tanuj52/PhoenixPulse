...
export default class News extends Component {
    ...
    updateNews = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=4991a0afe5e94f8ea28eb60875ac3b80&page=${this.state.page}&pageSize=${this.props.pageSize}`;
    ...
    handlePreviousClick = async () => {
        ...
        // let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=4991a0afe5e94f8ea28eb60875ac3b80&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
        // this.setState({ loading: true })
        // let data = await fetch(url);
        // let parsedData = await data.json();
        // console.log(parsedData);
